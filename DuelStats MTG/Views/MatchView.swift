...
struct MatchView: View {
    ...
    var body: some View {
        ZStack {
            ...
            WinnerPopUp(someoneWon: $someoneWon, winner: $winner, deck: $winnerDeck, title: String(localized: "Is \(winner.name) the winner?"), subtitle: String(localized: "Deck: \(winnerDeck.name)"))
        }
    }
}
